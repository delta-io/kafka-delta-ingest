...
async fn main() -> anyhow::Result<()> {
    ...
    let matches = clap_app!(kafka_delta_ingest =>
        ...
        (@subcommand ingest =>
            ...
            (@arg ADDITIONAL_KAFKA_SETTINGS: -K --Kafka +multiple_values +takes_value validator(parse_kafka_property)
            ...
            (@arg TRANSFORM: -t --transform +multiple_values +takes_value validator(parse_transform)
